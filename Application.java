...
public class Application {
	...
	public static void main(String[] args) {
		...
		Date d1 = new Date(01, 01, 2019);
		Date d2 = new Date(02, 21, 2018);
		Date d3 = new Date(05, 22, 2019);
		Date d4 = new Date(05, 28, 2019);
		Date d5 = new Date(04, 10, 2016);

		PaymentInfo p1 = new PaymentInfo("MasterCard", 654788521, 258);
		PaymentInfo p2 = new PaymentInfo("Discover", 60110009, 369);
		PaymentInfo p3 = new PaymentInfo("JCB", 353011133, 258);
		PaymentInfo p4 = new PaymentInfo("MasterCard", 555554444, 278);
		PaymentInfo p5 = new PaymentInfo("MasterCard", 55554444, 159);

		Orders o1 = new Orders(1001, c1, 12, d1, 120.0, b1, s1, p1);
		Orders o2 = new Orders(1005, c2, 1, d2, 10.02, b2, s2, p2);
		Orders o3 = new Orders(1004, c3, 25, d3, 190.05, b3, s3, p3);
		Orders o4 = new Orders(1011, c4, 30, d4, 210.00, b4, s4, p4);
		Orders o5 = new Orders(1000, c5, 2, d5, 40.02, b5, s5, p5);
